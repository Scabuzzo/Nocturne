      ...
      <div className="bg-gradient-to-r from-amber-900/20 to-red-900/20 rounded-lg p-6 border border-amber-500/20">
        ...
        <div className="bg-blue-900/20 border border-blue-500/20 rounded-lg p-4 mt-4">
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-blue-500/20 border border-blue-500/30 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
              <svg className="w-3 h-3 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
              </svg>
            </div>
            <div>
              <h5 className="text-blue-400 font-medium mb-1 text-sm">Virtual Trading Capital</h5>
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-900/30 border border-gray-800/50 rounded-lg p-5">
            ...
            <p className="text-gray-400 text-sm mt-2">
              Maximum loss per trade before position is closed
            </p>
          </div>
        ...
        <div className="bg-gray-900/30 border border-gray-800/50 rounded-lg p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <PremiumSlider
              ...
              value={riskManagement.maxDailyRisk}
              min={1}
              max={20}
              step={0.5}
              unit="%"
              onChange={(value) => onUpdate({ maxDailyRisk: value })}
            />
          </div>
          
          <p className="text-gray-400 text-sm mt-4">
            Fixed dollar amount per trade and maximum daily risk exposure
          </p>
        </div>
        ...
        <div className="bg-gray-900/30 border border-gray-800/50 rounded-lg p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => handleTrailingStopToggle(!riskManagement.trailingStop.enabled)}
              className={`
