...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-gray-700/20">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-gradient-to-t from-gray-950/95 via-black/90 to-gray-950/95 backdrop-blur-xl"></div>
      <div className="absolute inset-0 bg-gradient-to-t from-blue-950/10 via-transparent to-purple-950/10"></div>
          ...
          <div className="relative">
            {!walletConnected ? (
              ...
              <div className="relative">
                ...
                {/* Dropdown Menu */}
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-gray-900/95 backdrop-blur-xl border border-gray-700/50 rounded-xl shadow-2xl shadow-black/50">
                    ...
                    <div className="p-2">
                      <Link
                        href="/dashboard"
                        className="flex items-center gap-3 px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-lg transition-colors"
